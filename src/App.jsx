...
const searchItems = [
  ...
  { nombre: "Bag Soles", detalle: "Accesorios · Bags", url: "/accesorios/bags" },
  { nombre: "Bag Juveelina", detalle: "Accesorios · Bags", url: "/accesorios/bags" },
  { nombre: "Bag Sol", detalle: "Accesorios · Bags", url: "/accesorios/bags" },
  { nombre: "Bag Sols", detalle: "Accesorios · Bags", url: "/accesorios/bags" },
  ...
  { nombre: "Buzo peques blanco", detalle: "Vestimenta · Peques", url: "/vestimenta/peques" },
  { nombre: "Buzo peques negro", detalle: "Vestimenta · Peques", url: "/vestimenta/peques" },
  { nombre: "Camiseta peques celeste", detalle: "Vestimenta · Peques", url: "/vestimenta/peques" },
  { nombre: "Camiseta peques negra", detalle: "Vestimenta · Peques", url: "/vestimenta/peques" },
  { nombre: "Mujeres", detalle: "Vestimenta", url: "/vestimenta/mujeres" },
  { nombre: "Remera Escudo mujer", detalle: "Vestimenta · Mujeres", url: "/vestimenta/mujeres" },
  { nombre: "Remera Sol mujer", detalle: "Vestimenta · Mujeres", url: "/vestimenta/mujeres" },
  { nombre: "Remera espalda mujer", detalle: "Vestimenta · Mujeres", url: "/vestimenta/mujeres" },
  { nombre: "Hombres", detalle: "Vestimenta", url: "/vestimenta/hombres" },
  { nombre: "Remera Sol blanca", detalle: "Vestimenta · Hombres", url: "/vestimenta/hombres" },
  { nombre: "Remera Escudo blanca", detalle: "Vestimenta · Hombres", url: "/vestimenta/hombres" },
  { nombre: "Remera Sol gris", detalle: "Vestimenta · Hombres", url: "/vestimenta/hombres" },
  { nombre: "Remera Escudo gris", detalle: "Vestimenta · Hombres", url: "/vestimenta/hombres" },
  { nombre: "Remera Sol marrón", detalle: "Vestimenta · Hombres", url: "/vestimenta/hombres" },
  { nombre: "Remera Sol negra", detalle: "Vestimenta · Hombres", url: "/vestimenta/hombres" },
  { nombre: "Remera Escudo negra", detalle: "Vestimenta · Hombres", url: "/vestimenta/hombres" },
];
